...
export function SocialMediaCard() {
  return (
    <section className='w-full px-4 py-8'>
      <h6 className='mb-12 text-center text-6xl -tracking-widest lg:text-9xl'>
        socials
      </h6>
      <div className='mx-auto grid max-w-4xl grid-cols-3 gap-8'>
        ...
        <div className='flex flex-col items-center'>
          <Link
            href='https://www.tiktok.com/@dragonflyceramics?_t=ZT-8uFd3TGlJe7&_r=1'
            rel='noopener noreferrer'
        ...
        <div className='flex flex-col items-center'>
          <Link
            href='https://www.instagram.com/dragonflyceramics_?igsh=Y3ZxYTZqbzZjMWxx&utm_source=qr'
            rel='noopener noreferrer'
            className='mb-4 block transition-transform hover:scale-110 focus:scale-110 active:scale-95'
            target='_blank'
          >
            <Image
              src='/instagram-df.png'
              alt='Instagram'
              width={120}
              height={120}
              className='h-24 w-24 md:h-32 md:w-32'
        ...
        <div className='flex flex-col items-center'>
          <Link
            href='https://youtube.com/@dragonflyceramics?si=z3XyaYTzbkfRsiAe'
            rel='noopener noreferrer'
            className='mb-4 block transition-transform hover:scale-110 focus:scale-110 active:scale-95'
            target='_blank'
          >
