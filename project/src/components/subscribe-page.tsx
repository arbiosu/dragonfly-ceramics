...
export default function SubscribePage() {
  return (
    <section className='relative border-t-2 border-t-white bg-dfNew2 text-black'>
      <div className='absolute left-0 top-0 w-full overflow-hidden leading-[0]'>
        <svg
          ...
          className='relative block h-[240px] w-[calc(191%+1.3px)] md:h-[340px]'
        >
          <path
